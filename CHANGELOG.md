...
- **Test suite: 247 tests** — 112 unit, 59 integration against a real Postgres via testcontainers, 76 security. The security suite is negative: it passes when the database refuses.
