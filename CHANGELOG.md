...
- **Test suite: 299 tests** — 128 unit, 74 integration against a real Postgres via testcontainers, 97 security. The security suite is negative: it passes when the database refuses.
