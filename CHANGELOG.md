...
- **Test suite: 452 tests** — 220 unit, 94 integration against a real Postgres via testcontainers, 138 security. The security suite is negative: it passes when the database refuses.
