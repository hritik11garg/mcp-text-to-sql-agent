...
- **Test suite: 351 tests** — 169 unit, 74 integration against a real Postgres via testcontainers, 108 security. The security suite is negative: it passes when the database refuses.
