...
- **Test suite: 658 tests** — 338 unit, 94 integration against a real Postgres via testcontainers, 156 security, 70 contract. The security suite is negative: it passes when the database refuses. The contract suite launches the servers as real subprocesses and talks to them over real stdio.
